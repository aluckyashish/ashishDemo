    ...
    CheckoutModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                router_1.RouterModule.forChild(checkout_routes_1.CheckoutRoutes),
                forms_1.FormsModule,
                ng_bootstrap_1.NgbModule,
            ],
            declarations: [checkout_component_1.CheckoutComponent, success_component_1.SuccessComponent]
        })
    ], CheckoutModule);
